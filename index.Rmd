...
```{r, echo=FALSE}
knitr::include_url("https://www.youtube.com/embed/gl1aHhXnN1k")
```
...
This project was authored by [Samantha Brown](https://github.com/slb2240), [Laura Cosgrove](http://lauracosgrove.com/), and [Francis Zhang](https://github.com/Franc1sFrank). 